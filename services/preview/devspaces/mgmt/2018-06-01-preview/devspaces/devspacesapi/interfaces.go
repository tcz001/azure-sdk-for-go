...
import (
	"context"
	"github.com/tcz001/azure-sdk-for-go/services/preview/devspaces/mgmt/2018-06-01-preview/devspaces"
)
...
type ContainerHostMappingsClientAPI interface {
	GetContainerHostMapping(ctx context.Context, containerHostMapping devspaces.ContainerHostMapping, location string) (result devspaces.SetObject, err error)
}
