...
import (
	"context"
	"github.com/tcz001/azure-sdk-for-go/services/preview/devspaces/mgmt/2019-01-01-preview/devspaces"
)
...
type ContainerHostMappingsClientAPI interface {
	GetContainerHostMapping(ctx context.Context, containerHostMapping devspaces.ContainerHostMapping, resourceGroupName string, location string) (result devspaces.SetObject, err error)
}
...
type ControllersClientAPI interface {
	...
	ListConnectionDetails(ctx context.Context, resourceGroupName string, name string) (result devspaces.ControllerConnectionDetailsList, err error)
