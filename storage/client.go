...
import (
	...
	"github.com/tcz001/azure-sdk-for-go/version"
...
func (c Client) exec(verb, url string, headers map[string]string, body io.Reader, auth authentication) (*http.Response, error) {
	...
	for k, v := range headers {
		req.Header[k] = append(req.Header[k], v) // Must bypass case munging present in `Add` by using map functions directly. See https://github.com/tcz001/azure-sdk-for-go/issues/645
	}
